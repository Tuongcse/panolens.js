...
function Viewer(options) {
    ...
    options.autoHideInfospot !== undefined ? options.autoHideInfospot : false;
    ...
    this.renderer =
    options.renderer ||
    new WebGLRenderer({ alpha: true, antialias: false });
...
Viewer.prototype = Object.assign(
    Object.create(EventDispatcher.prototype),
    {
        ...
        addViewIndicator: function () {
            ...
            scope.camera.rotation.y - Math$1.degToRad(90);
